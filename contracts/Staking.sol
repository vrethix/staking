...
contract Staking is ReentrancyGuard, Pausable, Ownable {
    ...
    // unstaking possible after 30 
    uint public constant cliffTime = 120 ;
    ...
    function getReward() public virtual nonReentrant {
        ...
        uint fee;
        uint amountAfterFee;
        if(block.timestamp > stakingStartTime[msg.sender] + 120  && block.timestamp < stakingStartTime[msg.sender] + 181 ){
        ...
        if(block.timestamp > stakingStartTime[msg.sender] + 180  && block.timestamp < stakingStartTime[msg.sender] + 241 ){
            reward = rewards[msg.sender];
            if(reward > 0) {
        ...
        if(block.timestamp > stakingStartTime[msg.sender] + 240  && block.timestamp < stakingStartTime[msg.sender] + 301 ){
            reward = rewards[msg.sender];
            if(reward > 0) {
        ...
        if(block.timestamp > stakingStartTime[msg.sender] + 120  && block.timestamp < stakingStartTime[msg.sender] + 151 ){
            reward = rewards[msg.sender];
            if(reward > 0) {
        ...
        if(block.timestamp > stakingStartTime[msg.sender] + 300 ){
            reward = rewards[msg.sender];
            if (reward > 0) {
                rewards[msg.sender] = 0;
